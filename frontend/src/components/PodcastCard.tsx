...
const PodcastCard = ({name, id, iurl, desc, surl}: CardProps) => {
    ...
    return (
        <a href={surl} className="transition ease-in-out  bg-blue-500 hover:-translate-y-1 hover:scale-105 hover:bg-[#1DB954] duration-200 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-2xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 m-3">
